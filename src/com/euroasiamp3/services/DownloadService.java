...
import com.euroasiamp3.es.DownloadingActivity;
import com.euroasiamp3.es.R;
...
public class DownloadService extends Service {
	...
	public class DownloadFilesTask  extends AsyncTask<String, Void, Void> {
		...
		protected void onCancelled() {
			...
			regularNotif("Unduhan Dibatalkan","Dibatalkan: "+filename,filename); 
		...
		protected void onPostExecute(Void result) {
			...
			if(fail == 1){
				regularNotif("Gagal Diunduh","Gagal: "+filename,filename); 
				http--;
				...
				regularNotif("Unduhan Selesai","Selesai: "+filename,filename); 
			}
		...
		public void ongoingNotif(String contentTitle, String tickerText, String contentText ){
			...
			notification.setLatestEventInfo(context, contentTitle, "Klik Di Sini untuk Melihat Perkembangan", contentIntent);
			notificationManager.notify(numberd+9, notification);
		}
