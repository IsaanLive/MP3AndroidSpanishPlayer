...
public class DashboardActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		share.setOnClickListener(new OnClickListener() {
        	public void onClick(View v) {
				...
				i.putExtra(Intent.EXTRA_SUBJECT, "Cek Aplikasi Ini");
				i.putExtra(Intent.EXTRA_TEXT, "Dengan fitur fungsi pencarian ampuh, "+getString(R.string.app_name)+" memberi Anda jutaan lagu mutu-tinggi. Anda bisa menikmati secara online atau mengunduhnya secara gratis. Alami sendiri pesta audio sekarang juga! "+getString(R.string.app_name)+" Download Link: https://market.android.com/details?id="+getString(R.string.market_url));
				startActivity(Intent.createChooser(i, "Berbagi Aplikasi"));
        	}
		});
		...
		if(!isInternetConnectionActive(getApplicationContext())) {
			...
			builder.setMessage("Koneksi internet Anda harus aktif agar dapat memanfaatkan sebagian besar fitur pada aplikasi ini. Silakan ke Pengaturan Anda dan aktifkan wifi!")
				   .setCancelable(false)
	...
	public void rateapp(){		
		...
		if(hasBeenShown == false){
			String title = "Peringkatkan kami di Pasar Android";
			
			String message = "Pengguna yth., Jika Anda menyukai aplikasi kami, silakan beri 5 bintang. Dukungan tetap Anda merupakan sumber peningkatan mutu kami.";
 
			AlertDialog.Builder builder = new AlertDialog.Builder(this)
					.setTitle(title)
					.setMessage(message)
					.setPositiveButton("Beri Suara", new Dialog.OnClickListener() {
